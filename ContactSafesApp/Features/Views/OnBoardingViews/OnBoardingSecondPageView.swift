...
final class OnBoardingSecondPageView: BaseView<OnBoardingViewController> {
    ...
    private let onBoardingImageView: UIImageView = {
        let imageView = UIImageView(image: .onboardingImage2)
    ...
    private let onBoardingTitleLabel: UILabel = {
        let label = UILabel()
        label.text = OnboardingSlide.second.title
    ...
    private let onBoardingSubTitleLabel: UILabel = {
        let label = UILabel()
        label.text = OnboardingSlide.second.subTitle
        label.numberOfLines = .zero
    ...
    private lazy var onBoardingButton: UIButton = {
        ...
        button.setTitle(OnboardingSlide.second.buttonTitle, for: .normal)
